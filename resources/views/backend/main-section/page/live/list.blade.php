                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Slider-view</a></li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-header">
                    <div class="col-lg-12" align="right"> <a href="{{route('live.add')}}" class="btn btn-primary">Add Slider</a> </div>
                </div>
                <div class="card-box">
                    <div class="mb-2">
                        <div class="row">
                        ...
                        <table id="demo-foo-filtering" class="table table-bordered table-centered mb-0" data-page-size="7">
                            ...
                            <tbody>
                                <tr align="center">
                                    ...
                                    <td>
                                        @if($channel->status == '1')
                                        <a href="{{ route('ch.status',$channel->id)}}" class="btn btn-xs btn-primary">Active</a>
                                        @else
                                        <a href="{{ route('ch.status',$channel->id)}}" class="btn  btn-xs btn-danger">Inactive</a>
                                        @endif
                                    </td>
                                    <td>
