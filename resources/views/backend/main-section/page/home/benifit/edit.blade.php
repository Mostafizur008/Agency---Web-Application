        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="modal-header bg-success">
                    <h4 class="modal-title" id="myCenterModalLabel">Edit Benefit</h4>
                </div>
                <div class="card-box">
                <form action="{{route('bn',$editData->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="description" id="description"  placeholder="Description" class="form-control">{{$editData->description}}</textarea>
                            </div>
                         </div>
