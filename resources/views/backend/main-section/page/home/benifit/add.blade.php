        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="modal-header bg-success">
                    <h4 class="modal-title" id="myCenterModalLabel">Add Benefit</h4>
                </div>
                <div class="card-box">
                <form action="{{route('bn.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-2">
                            <label for="image" style="cursor: pointer;">
                                ...
                                <br/>
                                <span class="badge rounded-pill">Icon type Logo</span>
                            </label>
