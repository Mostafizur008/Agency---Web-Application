...
<div class="row">
                ...
                <table id="demo-foo-filtering" class="table table-bordered table-centered mb-0" data-page-size="7">
                    ...
                    <tbody>
                        <tr align="center">
                            ...
                            <td>
                                @if($channel->status == '1')
                                <a href="{{ route('pe.status',$channel->id)}}" class="btn btn-xs btn-primary">Active</a>
                                @else
                                <a href="{{ route('pe.status',$channel->id)}}" class="btn  btn-xs btn-danger">Inactive</a>
                                @endif
                            </td>
                            <td>
                                <a type="button" href="{{route('pe.edit',$channel->id)}}" class="btn btn-xs btn-primary"><i class="fe-edit"></i></a>
    ...
    <div class="col-lg-5">
        ...
        <div class="card-box">
            <form action="{{ isset($editData) ? route('pe', $editData->id) : route('pe.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @if(isset($editData))
                    @method('PUT')
                @endif
                <div class="row">
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name="title" id="title" placeholder="Title" class="form-control" value="{{ isset($editData) ? $editData->title : '' }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <label for="image" style="cursor: pointer;">
                            ...
                            <br />
                            <span class="badge rounded-pill">Certification Image</span>
                    ...
                    <div class="col-sm-6 col-md-12">
                        <div class="form-group">
                            <label>Summery</label>
                            <textarea name="summery" class="summery">{{ isset($editData) ? $editData->summery : '' }}</textarea>
                        </div>
                    </div>
...
@include('backend.code-section.ajax-script.live.product')
