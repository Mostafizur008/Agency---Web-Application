        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="modal-header bg-success">
                    <h4 class="modal-title" id="myCenterModalLabel">Edit Supplier</h4>
                </div>
                <div class="card-box">
                <form action="{{route('supplier',$editData->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                         ...
                         <div class="col-sm-6 col-md-3">
                            ...
                            <br/>
                            <span class="badge rounded-pill">Image 1370x485</span>
                        </label>
                        </div>
